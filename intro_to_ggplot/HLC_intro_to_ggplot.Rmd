...
# Refer back to the Data Structures lesson to review this notation
ggplot(data = gapminder[gapminder$country == "China", ], 
...
ggplot(data = gapminder[gapminder$continent == "Asia", ], 
...
ggplot(gapminder[gapminder$year > 1995, ], aes(x = gdpPercap, y = lifeExp, color = continent)) +
