...
Use `sapply` and an if/else statement that identifies values in `days` as either a weekend day with the number 1 or a weekday with the number 2 (e.g. the output vector produced should start with 1, 2, 2...).
