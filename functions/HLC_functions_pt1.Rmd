...
author: "Amy Pomeroy & Dayne Filer; Modified by Grace Di Cecco"
date: "May 29, 2018"
output:
  pdf_document:
    highlight: tango
...
$\color{blue}{\text{Hint:}}$ Use the `list` function within the `return` function to output more than one object.
...
$\color{blue}{\text{Hint:}}$ Use the function `str_count` in the library `stringr` to count the G's.
